...
//        model.addAttribute("list", recipeboardService.boardList1(1));
//        System.out.println(model.addAttribute("list", recipeboardService.boardList1(1)));
        return "";
    }
